...
<nav class="navbar navbar-expand-lg navbar-light bg-white shadow">
    <div class="container">
        <a class="navbar-brand" href="#"><span class="fa fa-spinner fa-spin fa-1.5x fa-fw"></span>Sistema Predictivo de Celda de Flotacion</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="/diagnose">Prediccion</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="#">Data + Visualisaciones</a>
                </li>
                <li class="nav-item">
